...
<div class="bodywrapper firstDiv">
    ...
    <div class="header">
    	<ul class="headermenu">
            <li class="current"><a href="{{action('PatientController@create')}}"><span class="icon icon-pub"></span><span class="span_hidden">Patients</span></a></li>
        </ul>        
        <ul class="headermenu">
            <li class="current"><a href="{{action('ConsultationController@create')}}"><span class="icon icon-pub"></span><span class="span_hidden">Consultations</span></a></li>
        </ul>
		<ul class="headermenu">
            <li class="current"><a href="{{action('RendezvousController@create')}}"><span class="icon icon-pub"></span><span class="span_hidden">Rendez-vous</span></a></li>
        </ul>
    </div><!--header-->
@yield('menuleft')
@yield('content')
